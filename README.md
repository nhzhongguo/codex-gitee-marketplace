...
![检查 Gitee 账号的演示](https://gitee.com/yuchen996/codex-gitee-marketplace/raw/main/docs/images/demo-account-check.png)

### 安全上传: 先预览，再确认

![安全上传预览与确认的演示](https://gitee.com/yuchen996/codex-gitee-marketplace/raw/main/docs/images/demo-safe-upload.png)

### AI 一键安装

![让 AI 安装插件市场的演示](https://gitee.com/yuchen996/codex-gitee-marketplace/raw/main/docs/images/demo-ai-install.png)
